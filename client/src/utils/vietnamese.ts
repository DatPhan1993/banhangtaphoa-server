 ...
 * Converts text like "mộc", "mốc" to "moc" for search purposes
 */
...
/**
 * Check if text matches search term (with Vietnamese diacritics support)
 * @param text - The text to search in
 * @param searchTerm - The search term
 * @returns true if text contains searchTerm (ignoring diacritics)
 */
export const vietnameseSearch = (text: string, searchTerm: string): boolean => {
